import { c as create_ssr_component, l as getContext, b as subscribe, v as validate_component, g as escape, a as add_attribute, e as each, h as compute_rest_props, i as spread, j as escape_attribute_value, k as escape_object, p as createEventDispatcher, o as onDestroy, r as get_store_value, d as add_styles, f as merge_ssr_styles, s as setContext, m as missing_component, t as hasContext, u as compute_slots, n as noop, q as null_to_empty } from "./ssr.js";
import { t as tick } from "./scheduler.js";
import { v4 } from "uuid";
import { a as toast } from "./Toaster.svelte_svelte_type_style_lang.js";
import "mermaid";
import { g as getCtx, a as generateId, s as styleToString, b as getCursorStyle, D as Drawer, P as Pane$1, c as Pane_group } from "./Drawer.js";
import { g as goto } from "./client.js";
import { p as page } from "./stores.js";
import { R as RETRIEVAL_API_BASE_URL, B as tools, e as toolServers, a as settings, c as config, u as user, r as models, m as mobile, T as TTSWorker, j as WEBUI_API_BASE_URL, t as temporaryChatEnabled, W as WEBUI_NAME, d as chatId, n as showSidebar, C as showControls, D as banners, A as functions, E as showCallOverlay, g as theme, F as showArtifacts, G as showOverview, h as WEBUI_BASE_URL, b as currentChatPage, s as socket, H as chatTitle, k as chats, l as tags } from "./index2.js";
import { a as compressImage, b as blobToFile, d as createMessagesList, s as sanitizeResponseContent, e as convertMessagesToHistory, p as promptTemplate, f as processDetails, g as getPromptVariables, h as getMessageContentParts, r as removeAllDetails, c as copyToClipboard } from "./index3.js";
import { h as getChatById, j as getTagsById, u as updateChatById, d as getChatList, k as createNewChat, f as getAllTags } from "./MagnifyingGlass.js";
import { b as generateEmoji, c as getTaskIdsByChatId, d as chatAction, e as generateOpenAIChatCompletion, s as stopTask, f as generateMoACompletion, h as chatCompleted } from "./index7.js";
import { EventSourceParserStream } from "eventsource-parser/stream";
import { u as updateUserSettings, a as getUserSettings, b as getAndUpdateUserLocation } from "./index6.js";
import { b as getUserValvesById, c as getUserValvesSpecById, d as getTools } from "./index8.js";
import "dompurify";
import { marked } from "marked";
import { u as uploadFile } from "./AutoCompletion.js";
import "yaml";
import "dequal";
import "./create.js";
import "dayjs";
...
import { C as Collapsible, a as Cube, b as Clipboard, S as SVGPanZoom } from "./Collapsible.js";
import "turndown";
...
import { T as Tags_1, S as ShareChatModal, P as PencilSquare } from "./PencilSquare.js";
import { S as Selector } from "./Selector.js";
import { T as Tooltip } from "./Tooltip.js";
import { M as Menu_sub, a as Menu_sub_trigger, b as Menu_sub_content } from "./menu-sub-trigger.js";
...
import { M as Map$1, U as UserMenu } from "./UserMenu.js";
...
import { V as Valves, c as getFunctions, H as Heart } from "./Heart.js";
import { S as Spinner } from "./Spinner.js";
import { F as FileItem } from "./FileItem.js";
import { s as synthesizeOpenAISpeech, t as transcribeAudio } from "./index10.js";
...
const MessageInput = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    (atSelectedModel?.id ? [atSelectedModel.id] : selectedModels).filter((model) => $models.find((m) => m.id === model)?.info?.meta?.capabilities?.file_upload ?? true);
    ...
    toolServers2.length + selectedToolIds.length > 0;
...
const ModelSelector = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="flex flex-col w-full items-start">${each(selectedModels, (selectedModel, selectedModelIdx) => {
      return `<div class="flex w-full max-w-fit"><div class="overflow-hidden w-full"><div class="mr-1 max-w-full">${validate_component(Selector, "Selector").$$render(
        $$result,
        {
          ...
          showTemporaryChatControl: $user?.role === "user" ? ($user?.permissions?.chat?.temporary ?? true) && !($user?.permissions?.chat?.temporary_enforced ?? false) : true,
          pinModelHandler,
          value: selectedModel
        },
        {
    ...
    })}</div> ${showSetDefault ? `<div class="absolute text-left mt-[1px] ml-1 text-[0.7rem] text-gray-600 dark:text-gray-400 font-primary"><button>${escape($i18n.t("Set as default"))}</button></div>` : ``}`;
  } while (!$$settled);
  $$unsubscribe_models();
  $$unsubscribe_settings();
  $$unsubscribe_i18n();
      ...
      return `<div slot="content">${validate_component(Menu_content, "DropdownMenu.Content").$$render(
        ...
        {},
        {
          default: () => {
            ...
            )}` : ``} ${!$temporaryChatEnabled && ($user?.role === "admin" || ($user.permissions?.chat?.share ?? true)) ? `${validate_component(Menu_item, "DropdownMenu.Item").$$render(
              $$result,
              {
                class: "flex gap-2 items-center px-3 py-2 text-sm  cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md",
...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(ShareChatModal, "ShareChatModal").$$render(
      ...
      {
        default: () => {
          return `<button class="flex cursor-pointer px-2 py-2 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-850 transition" id="chat-context-menu-button" data-svelte-h="svelte-1cq3yl7"><div class="m-auto self-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM12.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM18.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z"></path></svg></div></button>`;
        }
      }
    )}` : ``} ${validate_component(Tooltip, "Tooltip").$$render($$result, { content: $i18n.t("Controls") }, {}, {
      default: () => {
        return `<button class="flex cursor-pointer px-2 py-2 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-850 transition" aria-label="Controls"><div class="m-auto self-center">${validate_component(AdjustmentsHorizontal, "AdjustmentsHorizontal").$$render($$result, { className: " size-5", strokeWidth: "0.5" }, {}, {})}</div></button>`;
      }
    ...
    )}` : ``}</div></div></div></div> ${!history.currentId && !$chatId && ($banners.length > 0 || ($config?.license_metadata?.type ?? null) === "trial" || ($config?.license_metadata?.seats ?? null) !== null && $config?.user_count > $config?.license_metadata?.seats) ? `<div class="w-full z-30 mt-5"><div class="flex flex-col gap-1 w-full">${($config?.license_metadata?.type ?? null) === "trial" ? `${validate_component(Banner, "Banner").$$render(
      $$result,
      {
        banner: {
          type: "info",
...
const Controls = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$result.head = previous_head;
    $$rendered = `<div class="dark:text-white"><div class="flex items-center justify-between dark:text-gray-100 mb-2"><div class="text-lg font-medium self-center font-primary">${escape($i18n.t("Chat Controls"))}</div> <button class="self-center">${validate_component(XMark, "XMark").$$render($$result, { className: "size-3.5" }, {}, {})}</button></div> <div class="dark:text-gray-200 text-sm font-primary py-0.5 px-0.5">${chatFiles.length > 0 ? `${validate_component(Collapsible, "Collapsible").$$render(
      $$result,
      {
        title: $i18n.t("Files"),
        open: true,
    ...
    )} ${$user?.role === "admin" || $user?.permissions.chat?.controls ? `<hr class="my-2 border-gray-50 dark:border-gray-700/10"> ${validate_component(Collapsible, "Collapsible").$$render(
      $$result,
      {
...
const Overview = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_i18n();
  $$unsubscribe_nodes();
  return `<div class="w-full h-full relative"><div class="absolute z-50 w-full flex justify-between dark:text-gray-100 px-4 py-3.5"><div class="flex items-center gap-2.5"><button class="self-center p-0.5">${validate_component(ArrowLeft, "ArrowLeft").$$render($$result, { className: "size-3.5" }, {}, {})}</button> <div class="text-lg font-medium self-center font-primary">${escape($i18n.t("Chat Overview"))}</div></div> <button class="self-center p-0.5">${validate_component(XMark, "XMark").$$render($$result, { className: "size-3.5" }, {}, {})}</button></div> ${$nodes.length > 0 ? `${validate_component(Flow, "Flow").$$render($$result, { nodes, nodeTypes, edges }, {}, {})}` : ``}</div>`;
});
...
const Artifacts = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_i18n();
  $$unsubscribe_settings();
  return `<div class="w-full h-full relative flex flex-col bg-gray-50 dark:bg-gray-850"><div class="w-full h-full flex flex-col flex-1 relative">${contents.length > 0 ? `<div class="pointer-events-auto z-20 flex justify-between items-center p-2.5 font-primar text-gray-900 dark:text-white"><button class="self-center pointer-events-auto p-1 rounded-full bg-white dark:bg-gray-850">${validate_component(ArrowLeft, "ArrowLeft").$$render(
    $$result,
    {
    ...
    default: () => {
      return `<button class="bg-none border-none text-xs bg-gray-50 hover:bg-gray-100 dark:bg-gray-850 dark:hover:bg-gray-800 transition rounded-md p-0.5">${validate_component(ArrowDownTray, "ArrowDownTray").$$render($$result, { className: "size-3.5" }, {}, {})}</button>`;
    }
...
const ChatControls = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(SvelteFlowProvider, "SvelteFlowProvider").$$render($$result, {}, {}, {
      default: () => {
        return `${!largeScreen ? `${$showControls ? `${validate_component(Drawer, "Drawer").$$render(
          $$result,
          {
            show: $showControls,
            onClose: () => {
          ...
          },
          {
            default: () => {
              return `${$showControls ? `<div class="flex max-h-full min-h-full"><div class="${"w-full " + escape(
                ...
                true
              ) + " z-40 pointer-events-auto overflow-y-auto scrollbar-hidden"}">${$showCallOverlay ? `<div class="w-full h-full flex justify-center">${validate_component(CallOverlay, "CallOverlay").$$render(
                $$result,
                {
                  submitPrompt,
                  stopResponse,
...
const Placeholder = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="m-auto w-full max-w-6xl px-2 @2xl:px-20 translate-y-6 py-24 text-center">${$temporaryChatEnabled ? `${validate_component(Tooltip, "Tooltip").$$render(
      ...
      {
        default: () => {
          return `<div class="flex items-center gap-2 text-gray-500 font-medium text-lg my-2 w-fit">${validate_component(EyeSlash, "EyeSlash").$$render($$result, { strokeWidth: "2.5", className: "size-5" }, {}, {})}${escape($i18n.t("Temporary Chat"))}</div>`;
        }
      }
    )}` : ``} <div class="w-full text-3xl text-gray-800 dark:text-gray-100 text-center flex items-center gap-4 font-primary"><div class="w-full flex flex-col justify-center items-center"><div class="flex flex-row justify-center gap-3 @sm:gap-3.5 w-fit px-5"><div class="flex shrink-0 justify-center"><div class="flex -space-x-4 mb-0.5">${each(models$1, (model, modelIdx) => {
        ...
        {},
        {
          default: () => {
            return `<button><img crossorigin="anonymous"${add_attribute(
              ...
              0
            )} class="size-9 @sm:size-10 rounded-full border-[1px] border-gray-100 dark:border-none" alt="logo" draggable="false"></button> `;
          }
        }
      )}`;
    })}</div></div> <div class="text-3xl @sm:text-3xl line-clamp-1">${models$1[selectedModelIdx]?.name ? `${escape(models$1[selectedModelIdx]?.name)}` : `${escape($i18n.t("Hello, {{name}}", { name: $user?.name }))}`}</div></div> <div class="flex mt-1 mb-2"><div>${models$1[selectedModelIdx]?.info?.meta?.description ?? null ? `${validate_component(Tooltip, "Tooltip").$$render(
      $$result,
      {
        className: " w-fit",
      ...
      {}
    )}</div></div></div> <div class="mx-auto max-w-2xl font-primary mt-2"><div class="mx-5">${validate_component(Suggestions, "Suggestions").$$render(
      $$result,
      {
...
const Chat = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const sendPromptSocket = async (_history, model, responseMessageId, _chatId) => {
    ...
    const chatMessageFiles = chatMessages.filter((message) => message.files).flatMap((message) => message.files);
  ...
  do {
      ...
      if (chatIdProp) {
        (async () => {
          ...
          if (localStorage.getItem(`chat-input${chatIdProp ? `-${chatIdProp}` : ""}`)) {
            try {
              const input = JSON.parse(localStorage.getItem(`chat-input${chatIdProp ? `-${chatIdProp}` : ""}`));
              if (!$temporaryChatEnabled) {
                prompt = input.prompt;
                files = input.files;
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-5280jy_START -->${$$result.title = `<title> ${escape($chatTitle ? `${$chatTitle.length > 30 ? `${$chatTitle.slice(0, 30)}...` : $chatTitle} • ${$WEBUI_NAME}` : `${$WEBUI_NAME}`)} </title>`, ""}<!-- HEAD_svelte-5280jy_END -->`, ""} <audio id="audioElement" src="" style="display: none;"></audio> ${validate_component(ConfirmDialog, "EventConfirmDialog").$$render(
      $$result,
      {
      ...
      {}
    )} <div class="${"h-screen max-h-[100dvh] transition-width duration-200 ease-in-out " + escape($showSidebar ? "  md:max-w-[calc(100%-260px)]" : " ", true) + " w-full max-w-full flex flex-col"}" id="chat-container">${!loading ? `<div class="w-full h-full flex flex-col">${$settings?.backgroundImageUrl ?? null ? `<div class="${"absolute " + escape(
            ...
            {},
            {
              default: () => {
                return `${validate_component(Navbar, "Navbar").$$render(
                  ...
                  {}
                )} <div class="flex flex-col flex-auto z-10 w-full @container">${$settings?.landingPageMode === "chat" || createMessagesList(history, history.currentId).length > 0 ? `<div class="pb-2.5 flex flex-col justify-between w-full flex-auto overflow-auto h-0 max-w-full z-10 scrollbar-hidden" id="messages-container"${add_attribute("this", messagesContainerElement, 0)}><div class="h-full w-full flex flex-col">${validate_component(Messages, "Messages").$$render(
                  $$result,
                  {
                    chatId: $chatId,
                    selectedModels,
                  ...
                  {}
                )} <div class="absolute bottom-1 text-xs text-gray-500 text-center line-clamp-1 right-0 left-0" data-svelte-h="svelte-ko82kn"></div></div>` : `<div class="overflow-auto w-full h-full flex items-center">${validate_component(Placeholder, "Placeholder").$$render(
                  $$result,
                  {
                    history,
                    selectedModels,
    ...
    )}</div>` : `${loading ? `<div class="flex items-center justify-center h-full w-full"><div class="m-auto">${validate_component(Spinner, "Spinner").$$render($$result, {}, {}, {})}</div></div>` : ``}`}</div>`;
  } while (!$$settled);
