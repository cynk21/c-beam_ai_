import { c as create_ssr_component, a as add_attribute, b as subscribe, p as createEventDispatcher, v as validate_component, g as escape, e as each, l as getContext, o as onDestroy } from "../../../../../chunks/ssr.js";
import { p as page } from "../../../../../chunks/stores.js";
import { t as tick } from "../../../../../chunks/scheduler.js";
import { a as toast } from "../../../../../chunks/Toaster.svelte_svelte_type_style_lang.js";
import { c as Pane_group, P as Pane, D as Drawer } from "../../../../../chunks/Drawer.js";
import { g as goto } from "../../../../../chunks/client.js";
import { I as activeUserIds, h as WEBUI_BASE_URL, J as emojiShortCodes, a as settings, u as user, K as shortCodesToEmojis, m as mobile, c as config, j as WEBUI_API_BASE_URL, n as showSidebar, s as socket, d as chatId } from "../../../../../chunks/index2.js";
...
import { M as Markdown } from "../../../../../chunks/Collapsible.js";
import { P as ProfileImage, N as Name } from "../../../../../chunks/ProfileImage.js";
...
import { i as formatDate, a as compressImage } from "../../../../../chunks/index3.js";
...
const Messages = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${messages ? (() => {
    ...
    return ` <div>${!top ? `${validate_component(Loader, "Loader").$$render($$result, {}, {}, {
      ...
      $settings?.widescreenMode ?? null ? "max-w-full" : "max-w-5xl",
      true
    ) + " mx-auto"}">${channel ? `<div class="flex flex-col gap-1.5 pb-5 pt-10"><div class="text-2xl font-medium capitalize">${escape(channel.name)}</div> <div class="text-gray-500">${escape($i18n.t("This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.", {
      createdAt: dayjs(channel.created_at / 1e6).format("MMMM D, YYYY"),
      channelName: channel.name
    }))}</div></div>` : `<div class="flex justify-center text-xs items-center gap-2 py-5" data-svelte-h="svelte-yiui51"><div class="">Start of the channel</div></div>`} ${messageList.length > 0 ? `<hr class="border-gray-50 dark:border-gray-700/20 py-2.5 w-full">` : ``}</div>` : ``}`} ${each(messageList, (message, messageIdx) => {
...
const Channel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_user();
  $$unsubscribe_showSidebar();
  return `${$$result.head += `<!-- HEAD_svelte-dfmiil_START -->${$$result.title = `<title>#${escape(channel?.name ?? "Channel")} • Open WebUI</title>`, ""}<!-- HEAD_svelte-dfmiil_END -->`, ""} <div class="${"h-screen max-h-[100dvh] transition-width duration-200 ease-in-out " + escape($showSidebar ? "md:max-w-[calc(100%-260px)]" : "", true) + " w-full max-w-full flex flex-col"}" id="channel-container">${validate_component(Pane_group, "PaneGroup").$$render(
    $$result,
    {
